...
=item mget (?-options, remote dir, local dir, ?filter, ?time limit) -> success
...
Limit of time to spend may be specified in seconds.
...
=item mput (?-options, local dir, remote dir, ?filter, ?time limit) -> success
